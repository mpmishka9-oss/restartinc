        ...
        <motion.div key={q.id}
          ...
          {q.type === "textarea" && (
            <textarea
              ...
              placeholder={q.placeholder}
              rows={4}
              className="w-full mt-8 bg-white/10 border border-white/25 rounded-xl px-4 py-3.5 text-white placeholder:text-white/40 outline-none focus:border-rs-cream resize-none"
            />
          )}
